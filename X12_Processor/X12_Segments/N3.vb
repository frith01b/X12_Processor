...
Public Sub New()
   ...
   Public Overloads Sub InitializeTranDef() Implements SegTranslate.InitializeTranDef 
        ...
        SegmentDef.Name = "N3"
        SegmentDef.FieldDefList.add(New FieldDef("F01_BT_ADDR1", "ALPHA", 5, "NONE", "No", 0, "", "NONE", " ", ""))
        SegmentDef.FieldDefList.add(New FieldDef("F02_BT_ADDR2", "NUMERIC", 15, "NONE", "No", 0, "#,###.00", "NONE", " ", ""))
