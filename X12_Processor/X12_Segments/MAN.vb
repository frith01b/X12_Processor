 ...
 MyBase.New("") 
  End Sub 
   ...
   Public Overloads Sub InitializeTranDef() Implements SegTranslate.InitializeTranDef 
        ...
        SegmentDef.Name = "MAN"
        SegmentDef.FieldDefList.add(New FieldDef("F01_Mark_Qual", "ALPHA", 5, "NONE", "No", 0, "", "NONE", " ", ""))
        SegmentDef.FieldDefList.add(New FieldDef("F02_Mark_ID", "NUMERIC", 15, "NONE", "No", 0, "#,###.00", "NONE", " ", ""))
